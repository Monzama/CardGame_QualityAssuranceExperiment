...
class BlackjackGameTest(unittest.TestCase):
    ...
    def test_send_input_command_and_list(self):
        ...
        for command in commands_list:
            ...
            # Send each command
            input_bar.send_keys("\n")    # Simulate pressing Enter
            time.sleep(sleep_time+0.1)  # Allow time for each command to process
    ...
    def test_send_input_command_and_list_scenario3(self):
        ...
        #assert card count, shields, display final hand
        time.sleep(5)
        #TODO add in div items to display player hand count and player shield count and their updaters in JS and java
    ...
    def test_send_input_command_and_list_scenario4(self):
        ...
        # List of strings to parse and send
        commands_list = ["start","", "yes", "", "1","3","5","7","9","11", "Quit", "", "2","4","6","8","10","12", "Quit","",""
                        "","t", "1", "", "t", "4", "", "t", "3","","", "12", "Quit", "", "Quit", "", "Quit", "", "","1", "1" ,"","display hands"]
